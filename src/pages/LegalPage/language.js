...
const TC = (
  <React.Fragment>
    ...
    <p>
      ...
      of Commony's Website.
    </p>
    <br />
    <p>
      By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use Commony's website if you do not accept all
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Commony's website you consent to
      the use of cookies in accordance with Commony's privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Commony and/or it's licensors own the
      intellectual property rights for all material on Commony. All intellectual
      property rights are reserved. You may view and/or print pages from
      http://alexkim.dev for your own personal use subject to restrictions set
    ...
    <p>
      Redistribute content from Commony (unless content is specifically made for
      redistribution).
    </p>
    <h2>User Comments</h2>
    <ol>
      ...
      <li>
        ...
        areas of the website. Commony does not screen, edit, publish or review
        Comments prior to their appearance on the website and Comments do not
        reflect the views or opinions ofCommony, its agents or affiliates.
        Comments reflect the view and opinion of the person who posts such view
        or opinion. To the extent permitted by applicable laws Commonyshall not
      ...
      <li>
        Commonyreserves the right to monitor all Comments and to remove any
      ...
      <li>
        You hereby grant to <strong>Commony</strong> a non-exclusive
    ...
    <p>
      ...
      visibility associated with the hyperlink outweighs the absence of Commony;
    ...
    <p>
      ...
      e-mail to{" "}
      <a
        href="mailto:alexgkim205@gmail.com"
        title="send an email to alexgkim205@gmail.com"
      >
    ...
    <p>
      No use of Commony's logo or other artwork will be allowed for linking
...
const Privacy = (
  <React.Fragment>
    ...
    <p>
      It is Commony's policy to respect your privacy regarding any information
      we may collect while operating our website. This Privacy Policy applies to{" "}
      <a href="http://alexkim.dev">alexkim.dev</a> (hereinafter, "us", "we", or
      "alexkim.dev"). We respect your privacy and are committed to protecting
    ...
    <p>
      Like most website operators, Commony collects non-personally-identifying
      ...
      and the date and time of each visitor request. Commony's purpose in
      collecting non-personally identifying information is to better understand
      how Commony's visitors use its website. From time to time, Commony may
      release non-personally-identifying information in the aggregate, e.g., by
      publishing a report on trends in the usage of its website.
    </p>
    <p>
      Commony also collects potentially personally-identifying information like
      Internet Protocol (IP) addresses for logged in users and for users leaving
      comments on http://alexkim.dev blog posts. Commony only discloses logged
    ...
    <p>
      Certain visitors to Commony's websites choose to interact with Commony in
      ways that require Commony to gather personally-identifying information.
      The amount and type of information that Commony gathers depends on the
      nature of the interaction. For example, we ask visitors who sign up for a
      blog at http://alexkim.dev to provide a username and email address.
    </p>
    ...
    <p>
      Commony may collect statistics about the behavior of visitors to its
      website. Commony may display this information publicly or provide it to
      others. However, Commony does not disclose your personally-identifying
      information.
    </p>

    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Commony uses "Cookies",
    ...
    <p>
      ...
      the visitor returns. Commony uses cookies to help Commony identify and
      track visitors, their usage of http://alexkim.dev, and their website
      access preferences. Commony visitors who do not wish to have cookies
      placed on their computers should set their browsers to refuse cookies
      before using Commony's websites, with the drawback that certain features
      of Commony's websites may not function properly without the aid of
      cookies.
    </p>
    <p>
      By continuing to navigate our website without changing your cookie
      settings, you hereby acknowledge and agree to Commony's use of cookies.
    </p>

    <h2>Business Transfers</h2>
    <p>
      If Commony, or substantially all of its assets, were acquired, or in the
      unlikely event that Commony goes out of business or enters bankruptcy,
      ...
      and that any acquirer of Commony may continue to use your personal
      information as set forth in this policy.
    </p>

    <h2>Privacy Policy Changes</h2>
    <p>
      Although most changes are likely to be minor, Commony may change its
      Privacy Policy from time to time, and in Commony's sole discretion.
      Commony encourages visitors to frequently check this page for any changes
    ...
    <p>
      ...
      via <a href="mailto:alexgkim205@gmail.com">email</a> or{" "}
      <a href="tel:7187100555">phone</a>.
    </p>
  </React.Fragment>
);
