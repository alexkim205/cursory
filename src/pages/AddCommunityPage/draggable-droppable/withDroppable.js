...
export const targetSpec = {
  ...
  drop(props, monitor, component) {
    ...
    if (draggingOffsetY >= targetOffset.top && draggingOffsetY <
      ...
      console.log(`add ${draggedId},${draggedType} inside ${overId},${overType}`);
      targetSide = BorderHighlight.Center; //inside
    } else {
      console.log(`Default action: add ${draggedId},${draggedType} after ${overId},${overType}`);
...
export const connectAsTargetContainerItem = Component => DropTarget(
